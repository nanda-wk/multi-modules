...
function checkoutCart() {
  ...
  for(var i in cartArray) {
    ...
    + "<td class='d-table-cell'><img class='card-img-heigh' src=" + cartArray[i].imgsrc + "></td>"
    + "<td class='col d-table-cell'>" + cartArray[i].name + "</td>" 
    + "<td class='text-right d-table-cell'>" + cartArray[i].price + "</td>"
    + "<td class='text-right d-table-cell'>" + cartArray[i].count + "</td>"
    + " = " 
  ...
  + "</td>"
  + "<td class='text-right d-table-cell total-cart'></td>"
  + "</tr>";
